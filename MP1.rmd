...
```
The scatterplot shows a positive linear relationship between damage and the number of eliminations. This tells us that "Damage" and "Eliminations" are almost directly proportional to each other.
