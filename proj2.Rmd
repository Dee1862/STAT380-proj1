...
```
Using na.omit() would eliminate rows with even a single missing value. Additionally, given the large frequency of missing data as show by the output of the above code, it is better to remove these rows using the na.omit(). However, remove of this large data could impact the analysis quality.
